...
import {
  ...
  doc, setDoc, getDoc, arrayUnion, deleteDoc, onSnapshot
...
window.firestoreDB = { db, collection, addDoc, getDocs, query, where, orderBy, limit, doc, setDoc, getDoc, arrayUnion, deleteDoc, onSnapshot };